cc.Class({
    ...
    onEnable: function () { // 当该组件被启用，并且它的节点也激活时。
        cc.director.getCollisionManager().enabled = true; // 开启碰撞
        cc.director.getCollisionManager().enabledDebugDraw = true; // 显示碰撞的debug
    },

    onDisable: function () { // 当该组件被禁用或节点变为无效时调用。
